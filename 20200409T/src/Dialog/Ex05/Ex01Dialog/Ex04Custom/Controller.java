package Ex05.Ex01Dialog.Ex04Custom;
...
public class Controller implements Initializable{
	...
	public void CustomWindowShow() throws IOException{
		...
		customWnd.setTitle("»Æ¿Œ");
		
		Pane canvas = (Pane)FXMLLoader.load(getClass().getResource("popup.fxml"));
